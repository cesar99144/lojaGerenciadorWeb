...
<body>
    ...
    <div id="lista_usuarios" class="w3-margin sessao-pagina">
        ...
        <div class="topoDadosPagina">
            <h4 class="tituloPagina">Editar cliente</h4>
        ...
        <div class="w3-row area-inputs">
            <div class="container-input w3-margin-top">
                <label>Nome</label>
                <input type="text" name="nomeCliente" id="nomeCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['nome']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-input w3-margin-top">
                <label>Celular</label><br>
                <input type="text" id="celularCliente" name="celularCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['celular']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-input w3-margin-top">
                <label>Email</label><br>
                <input type="text" id="emailCliente" name="emailCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['email']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-input w3-margin-top">
                <label>Endereço</label><br>
                <input type="text" id="enderecoCliente" name="enderecoCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['endereco']; ?>">
            </div>&nbsp;&nbsp;&nbsp;
        ...
        <div class="w3-row area-inputs">
            <div class="container-input w3-margin-top">
                ...
                <input type="text" id="bairroCliente" name="bairroCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['bairro']; ?>">
            </div>&nbsp;&nbsp;&nbsp;
            <div class="container-select w3-margin-top">
                <label>UF</label><br>
                <input type="text" id="ufCliente" name="ufCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['uf']; ?>">
            </div>&nbsp;&nbsp;&nbsp;
            <div class="container-input w3-margin-top">
                <label>Cidade</label><br>
                <input type="text" id="cidadeCliente" name="cidadeCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['cidade']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-select w3-margin-top">
                <label>Código</label><br>
                <input type="text" id="codigoCliente" name="codigoCliente" class="w3-input w3-block w3-border" value="<?php echo $data['dadosCliente']['idCliente']; ?>" disabled>
            </div>&nbsp;&nbsp;&nbsp;
            
        </div>

        <div class="w3-row area-inputs w3-margin-top">
            <button type="button" onclick="atualizarCliente()" class="w3-button w3-theme w3-margin-top w3-margin-bottom">Atualizar</button>
