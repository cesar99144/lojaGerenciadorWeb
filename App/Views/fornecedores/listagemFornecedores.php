...
<html>
 ...
 <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/toastify-js/src/toastify.min.css">
  ...
  <body onload="carregarListaFornecedores()">
    
    <div>
      <div id="lista_usuarios" class="w3-margin sessao-pagina">
        <div class="topoDadosPagina">
            <h4 class="tituloPagina">Lista Fornecedores</h4>
        </div>
        <div id="areaTopoPagina">
          ...
          <div>
            <a href="<?php echo URL_BASE; ?>fornecedores/new" class="w3-button w3-theme w3-margin-top w3-right">Cadastrar novo fornecedor</a>
          </div>
        </div>
