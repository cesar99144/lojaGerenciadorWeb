...
<body>
    ...
    <div id="lista_usuarios" class="w3-margin sessao-pagina">
        ...
        <div class="topoDadosPagina">
            <h4 class="tituloPagina">Cadastro de fornecedor</h4>
        ...
        <div class="w3-row area-inputs">
            ...
            <div class="container-input w3-margin-top">
                <label>Cnpj</label>
                <input type="text" name="cnpjCliente" id="cnpjCliente" class="w3-input w3-block w3-border">
            </div>&nbsp;&nbsp;&nbsp;
        ...
        <div class="w3-row area-inputs w3-margin-top">
            <button type="button" onclick="cadastrar()" class="w3-button w3-theme w3-margin-top w3-margin-bottom">Gravar</button>
