...
<body>
    ...
    <div id="lista_usuarios" class="w3-margin sessao-pagina">
        ...
        <div class="topoDadosPagina">
            <h4 class="tituloPagina">Editar produto</h4>
        ...
        <div class="w3-row area-inputs">
            ...
            <div class="container-input w3-margin-top">
                <label>Nome</label>
                <input type="text" name="nomeProduto" id="nomeProduto" class="w3-input w3-block w3-border" value="<?php echo $data['dadosProduto']['nome']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-select w3-margin-top">
                <label>Estoque</label><br>
                <input type="text" id="estoqueProduto" name="estoqueProduto" class="w3-input w3-block w3-border" value="<?php echo $data['dadosProduto']['estoque']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-select w3-margin-top">
                <label>Preço</label><br>
                <input type="text" id="precoProduto" name="precoProduto" class="w3-input w3-block w3-border" value="<?php echo $data['dadosProduto']['preco']; ?>">
            </div>&nbsp;&nbsp;&nbsp;

            <div class="container-select w3-margin-top">
                <label>Código</label><br>
                <input type="text" id="codigoProduto" name="precoProduto" class="w3-input w3-block w3-border" value="<?php echo $data['dadosProduto']['idProduto']; ?>" disabled>
            </div>&nbsp;&nbsp;&nbsp;

        </div>

        <div class="w3-row area-inputs w3-margin-top">
            <button type="button" onclick="atualizarProduto()" class="w3-button w3-theme w3-margin-top w3-margin-bottom">Atualizar</button>
